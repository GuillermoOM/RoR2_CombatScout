...
namespace CombatScoutMod.Modules
{
    internal static class Assets
    {
        ...
        // CHANGE THIS
        private const string assetbundleName = "combatscoutassets";
        ...
        internal static void LoadAssetBundle()
        {
            ...
            {
                using (var assetStream = Assembly.GetExecutingAssembly().GetManifestResourceStream("CombatScoutMod." + assetbundleName))
                {
        ...
        {
            using (Stream manifestResourceStream2 = Assembly.GetExecutingAssembly().GetManifestResourceStream("CombatScoutMod.CombatScoutBank.bnk"))
            {
        ...
        internal static void PopulateAssets()
        {
            ...
            swordHitSoundEvent = CreateNetworkSoundEventDef("CombatScoutSwordHit");

            bombExplosionEffect = LoadEffect("BombExplosionEffect", "CombatScoutBombExplosion");
            ...
            swordSwingEffect = Assets.LoadEffect("CombatScoutSwordSwingEffect", true);
            swordHitImpactEffect = Assets.LoadEffect("ImpactCombatScoutSlash");
        }
