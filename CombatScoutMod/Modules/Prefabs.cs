...
namespace CombatScoutMod.Modules
{
    ...
    internal static class Prefabs
    {
        ...
        {
            string fullNameString = CombatScoutPlugin.developerPrefix + "_" + namePrefix + "_BODY_NAME";
            string fullDescString = CombatScoutPlugin.developerPrefix + "_" + namePrefix + "_BODY_DESCRIPTION";
            string fullOutroString = CombatScoutPlugin.developerPrefix + "_" + namePrefix + "_BODY_OUTRO_FLAVOR";
            string fullFailureString = CombatScoutPlugin.developerPrefix + "_" + namePrefix + "_BODY_OUTRO_FAILURE";
        ...
        {
            CombatScoutPlugin.DestroyImmediate(main.transform.Find("ModelBase").gameObject);
            CombatScoutPlugin.DestroyImmediate(main.transform.Find("CameraPivot").gameObject);
            CombatScoutPlugin.DestroyImmediate(main.transform.Find("AimOrigin").gameObject);
