...
namespace CombatScoutMod.Modules.Survivors
{
    internal class MyCharacter : SurvivorBase
    {
        internal override string bodyName { get; set; } = "CombatScout";
        ...
        internal override BodyInfo bodyInfo { get; set; } = new BodyInfo
        {
            armor = 10f,
            armorGrowth = 0f,
            bodyName = "CombatScoutBody",
            bodyNameToken = CombatScoutPlugin.developerPrefix + "_CombatScout_BODY_NAME",
            bodyColor = Color.grey,
            characterPortrait = Modules.Assets.LoadCharacterIcon("CombatScout"),
            ...
            moveSpeed = 12f,
            acceleration = 50f,
            subtitleNameToken = CombatScoutPlugin.developerPrefix + "_CombatScout_BODY_SUBTITLE",
            podPrefab = Resources.Load<GameObject>("Prefabs/NetworkedObjects/SurvivorPod")
        };

        internal static Material CombatScoutMat = Modules.Assets.CreateMaterial("matCombatScout");
        ...
        internal override void InitializeSkills()
        {
            ...
            string prefix = CombatScoutPlugin.developerPrefix;

            #region Primary
            SkillDef shootSkillDef = Modules.Skills.CreatePrimarySkillDef(new EntityStates.SerializableEntityStateType(
                typeof(SkillStates.BaseStates.BaseShootAttack)),
                "Weapon",
                prefix + "_CombatScout_BODY_PRIMARY_GUN_NAME",
                prefix + "_CombatScout_BODY_PRIMARY_GUN_DESCRIPTION",
                Modules.Assets.mainAssetBundle.LoadAsset<Sprite>("texSecondaryIcon"),
                true);

            Modules.Skills.AddPrimarySkill(bodyPrefab, shootSkillDef);
            #endregion

            #region Secondary
            SkillDef slashSkillDef = Modules.Skills.CreateSkillDef(new SkillDefInfo
            {
                skillName = prefix + "_CombatScout_BODY_SECONDARY_SLASH_NAME",
                skillNameToken = prefix + "_CombatScout_BODY_SECONDARY_SLASH_NAME",
                skillDescriptionToken = prefix + "_CombatScout_BODY_SECONDARY_SLASH_DESCRIPTION",
                skillIcon = Modules.Assets.mainAssetBundle.LoadAsset<Sprite>("texPrimaryIcon"),
                activationState = new EntityStates.SerializableEntityStateType(typeof(SkillStates.BoostCut)),
            ...
            Modules.Skills.AddSecondarySkills(bodyPrefab, slashSkillDef);
            #endregion

            #region Utility
            SkillDef rollSkillDef = Modules.Skills.CreateSkillDef(new SkillDefInfo
            {
                skillName = prefix + "_CombatScout_BODY_UTILITY_ROLL_NAME",
                skillNameToken = prefix + "_CombatScout_BODY_UTILITY_ROLL_NAME",
                skillDescriptionToken = prefix + "_CombatScout_BODY_UTILITY_ROLL_DESCRIPTION",
            ...
            {
                skillName = prefix + "_CombatScout_BODY_SPECIAL_BOMB_NAME",
                skillNameToken = prefix + "_CombatScout_BODY_SPECIAL_BOMB_NAME",
                skillDescriptionToken = prefix + "_CombatScout_BODY_SPECIAL_BOMB_DESCRIPTION",
        ...
        internal override void InitializeSkins()
        {
            ...
            #region DefaultSkin
            SkinDef defaultSkin = Modules.Skins.CreateSkinDef(CombatScoutPlugin.developerPrefix + "_CombatScout_BODY_DEFAULT_SKIN_NAME",
            ...
            defaultSkin.meshReplacements = new SkinDef.MeshReplacement[]
            {
                ...
                {
                    mesh = Modules.Assets.mainAssetBundle.LoadAsset<Mesh>("meshCombatScoutSword"),
                    renderer = defaultRenderers[0].renderer
                },
                new SkinDef.MeshReplacement
                {
                    mesh = Modules.Assets.mainAssetBundle.LoadAsset<Mesh>("meshCombatScoutGun"),
                    renderer = defaultRenderers[1].renderer
                },
                new SkinDef.MeshReplacement
                {
                    mesh = Modules.Assets.mainAssetBundle.LoadAsset<Mesh>("meshCombatScout"),
            ...
            #region MasterySkin
            Material masteryMat = Modules.Assets.CreateMaterial("matCombatScoutAlt");
            ...
            SkinDef masterySkin = Modules.Skins.CreateSkinDef(CombatScoutPlugin.developerPrefix + "_CombatScout_BODY_MASTERY_SKIN_NAME",
            ...
            masterySkin.meshReplacements = new SkinDef.MeshReplacement[]
            {
                new SkinDef.MeshReplacement
                {
                    mesh = Modules.Assets.mainAssetBundle.LoadAsset<Mesh>("meshCombatScoutSwordAlt"),
                    renderer = defaultRenderers[0].renderer
                },
                new SkinDef.MeshReplacement
                {
                    mesh = Modules.Assets.mainAssetBundle.LoadAsset<Mesh>("meshCombatScoutAlt"),
                    renderer = defaultRenderers[instance.mainRendererIndex].renderer
                }
            };
